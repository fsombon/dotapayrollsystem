...
public class Employee extends Person {
    ...
    public boolean insertEmployee() {
        ...
        String sql = "INSERT INTO employee (empId,fname,lname,designation,"
                + "department,gender) VALUES ('" + empId + "','" + fName + "','" + lName + "','"
                + designation + "','"
                + department + "','" + gender + "')";
    ...
    public boolean updateEmployee() {
        ...
        String sql = "UPDATE employee set fname='" + fName + "',lname='" + lName + "',designation='" + designation + "',"
